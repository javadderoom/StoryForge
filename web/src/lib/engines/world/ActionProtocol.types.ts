...
export const ENTITY_ALIASES: Record<string, EntityType> = {
  ...
  location_category: 'place_category',
  biome: 'place_category',
  biomes: 'place_category',
  ...
  'آیین': 'deity',
  'پانتئون': 'deity',
  'رویداد': 'timeline_event',
  'رویدادها': 'timeline_event',
  'حادثه': 'timeline_event',
  'عصر': 'timeline_event',
  'گاه‌شمار': 'timeline_event',
  'گاهشمار': 'timeline_event',
  'قانون': 'world_law',
  'قوانین': 'world_law',
  'قانون جهان': 'world_law',
  'قوانین جهان': 'world_law',
  'اصل': 'world_law',
  'دسته‌بندی مکان': 'place_category',
  'دسته بندی مکان': 'place_category',
  'دسته‌بندی مکان‌ها': 'place_category',
  'دسته‌بندی مکانها': 'place_category',
  'دسته‌بندی زیست‌بوم': 'place_category',
  'دسته‌بندی زیست بوم': 'place_category',
  'زیست‌بوم': 'place_category',
  'زیست بوم': 'place_category',
  'زیست‌بوم‌ها': 'place_category',
  'زیست بوم ها': 'place_category',
  'دسته‌بندی قانون': 'law_category',
  'دسته بندی قانون': 'law_category',
  'دسته‌بندی قوانین': 'law_category',
  'نقش شخصیت': 'npc_role',
  'نقش‌های شخصیت': 'npc_role',
  'نقشها': 'npc_role',
  'نقش‌ها': 'npc_role',
  'نقش': 'npc_role',
  'حوزه کیهانی': 'domain',
