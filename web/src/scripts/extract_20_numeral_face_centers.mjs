...
loader.parse(arrayBuffer, '', (gltf) => {
  ...
  console.log('const EXACT_20_NUMERAL_FACES =', JSON.stringify(faces, null, 2));
  fs.writeFileSync('src/lib/exact20Faces.json', JSON.stringify(faces, null, 2));
});
