...
class _ReaderScreenState extends ConsumerState<ReaderScreen> {
  ...
  void initState() {
    super.initState();
    Future.microtask(() {
      ref.read(gameSessionProvider.notifier).startStory('obsidian_citadel');
    });
  }
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      endDrawer: RpgHudDrawer(playerState: session.playerState),
      appBar: AppBar(
                          ...
                          Expanded(
                            child: TextField(
                              ...
                              decoration: InputDecoration(
                                hintText: 'Type custom action (e.g. search under bench)...',
